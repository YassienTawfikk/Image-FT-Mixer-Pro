...
class MainWindow(QMainWindow):
    ...
    def setup_control_panel(self):
        ...
        # CHANGED LABEL TEXT
        region_layout.addWidget(QLabel("Gaussian Sigma:"))
        self.region_size_slider = QSlider(Qt.Horizontal)
        # CHANGED RANGE and DEFAULT VALUE
        self.region_size_slider.setRange(1, 100)  # Min 1, Max 100 for Sigma
        self.region_size_slider.setValue(40)
